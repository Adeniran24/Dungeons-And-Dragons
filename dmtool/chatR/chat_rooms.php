...
<body>
    ...
    <ul>
        <?php while ($room = $result->fetch_assoc()): ?>
            <li style="list-style-type:  none;"><h2><a href="room_chat.php?room_id=<?= $room['id'] ?>"><?= htmlspecialchars($room['name']) ?></a></h2></li>
        <?php endwhile; ?>
    </ul>
    <a href="create_room.php"><h3>Create a new chat room</h3></a>
